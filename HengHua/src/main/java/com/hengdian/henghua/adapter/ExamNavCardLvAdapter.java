...
public class ExamNavCardLvAdapter extends BaseAdapter {
    public Context ctx;
...
//                setGridViewHeightBasedOnChildren(viewHolder.navCardGridView); //去掉这行代码
        ...
        if (position == 1) {
            if (multipleList == null || multipleList.size() == 0) {
                ...
                ExamNavCardGvAdapter examNavCardGvAdapter = new ExamNavCardGvAdapter(ctx, multipleList);
//                setGridViewHeightBasedOnChildren(viewHolder.navCardGridView); //去掉这行代码
                viewHolder.navCardGridView.setAdapter(examNavCardGvAdapter);
            }
        }
        if (position == 2) {
            if (trueOrFalseList == null || trueOrFalseList.size() == 0) {
                ...
                ExamNavCardGvAdapter examNavCardGvAdapter = new ExamNavCardGvAdapter(ctx, trueOrFalseList);
//                setGridViewHeightBasedOnChildren(viewHolder.navCardGridView); 去掉这行代码
                viewHolder.navCardGridView.setAdapter(examNavCardGvAdapter);
            }
        }
