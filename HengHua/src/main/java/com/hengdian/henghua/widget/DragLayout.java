...
*/
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            //判断关闭和打开,先判断什么时候打开，然后剩下的都是关闭状态
            //如果主面板的左侧距离屏幕左侧已经大于mRange/2的距离并且右滑的速度大于0，打开
            if (xvel >= 0 && mMainContent.getLeft() > mRange / 2.0f) {
                open();
            } else if (xvel > 200  && mMainContent.getLeft() > mRange / 5.0f) { //否则，右滑的速度大于200，打开
                open();
            } else {//剩余的所有情况都是关闭
                close();
            }
...
*/
    ...
    public void close(boolean isSmooth) {
        ...
        if (isSmooth) {
             ...
             * returns false there is no further work to doit to complete the movement.
             *
            ...
            if (mDragHelper.smoothSlideViewTo(mMainContent, finalLeft, 0)) {
                mDragHelper.smoothSlideViewTo(mLeftContent, 0 - mWidth, 0);
            ...
            mLeftContent.layout(0 - finalLeft, 0, 0 - finalLeft + mWidth, finalLeft + mHeight);
        }
