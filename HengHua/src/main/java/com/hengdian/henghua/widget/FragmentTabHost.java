 ...
 */
package com.hengdian.henghua.widget;
...
/**
 * Special TabHost that allows the use of {@link Fragment} objects for its tab content. When placing this in a view hierarchy, after inflating the hierarchy you must call {@link #setup(Context, FragmentManager, int)} to complete the
 ...
 * 
 * {@sample development/samples/Support4Demos/src/com/example/android/supportv4/app/FragmentTabsFragmentSupport.java complete}
 */
...
//			if (tab.fragment != null && !tab.fragment.isDetached()) {  原来的
...
//					ft.detach(mLastTab.fragment); 原来
